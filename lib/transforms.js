...
function transformRequest(provider, reqBody) {
  ...
  if (body.messages && body.messages.length > 0) {
    ...
    let PROXY_SYSTEM = [
      ...
      "- NEVER end with a summary of what you did. After completing a step, START THE NEXT STEP immediately.",
      "- NEVER say 'Time is limited' or 'Due to time constraints'. You have unlimited time. Complete everything.",
      "- NEVER say 'subsequent steps will...' or 'remaining work includes...' — DO IT NOW in this response.",
      "- If task is too large for one response: do as much as possible, then on 'continue' pick up EXACTLY where you left off.",
      "- ONE file at a time, FULLY implemented. Better to have 3 complete files than 10 stubs.",
      "",
      ...
      "Summarize what was done then stop|Write stubs/placeholders|Say 'time limited'|",
